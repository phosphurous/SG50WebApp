<script>
function GotoHome(){
	window.location = 'adminindexreg.php?';
}
</script>
<!DOCTYPE HTML>
<html>
	...
	<article id="main">
       ...
       <div id="wrap"> 
    	<div id="wrap2"> 
       	...
       	<h2 class="reg_account">Update Registrants</h2> 
        
    	<form id="frmParty" method="POST" action="adminindexreg.php">
...
<label for="eventknowledge">How do you know about this event?: </label><span class="val_eventknowledge"></span>
	...
	<input class="btn" type="submit" name="register" id="register" value="Update" />
